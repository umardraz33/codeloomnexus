  ...
  <body class="error-body no-top">
    <div class="container">
      <div class="row login-container column-seperation">
        ...
        <div class="col-md-5">
          <br>
          <form action="{{ route('register') }}" class="login-form validate" id="register-form" method="post" name="register-form">
            @csrf
            ...
            <div class="row">
              <div class="form-group col-md-10">
                <label for="password" class="form-label">Password</label> <span class="help"></span>
            ...
            <div class="row">
              <div class="col-md-10">
                  <a href="{{ route('login') }}" class="btn btn-primary btn-cons pull-right" type="button">Login</a>
              </div>
            </div>
          </form>
        </div>
