...
<!-- Mirrored from webarch.revox.io/3.0/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Dec 2023 19:19:14 GMT -->
        ...
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-offset-1 col-xs-10">
          <div class="error-container">
            <div class="error-main">
              ...
              <div class="error-description"> Access Denied. </div>
              <div class="error-description-mini"> You do not have permission to access this page.</div>
              <br>
              {{-- <div class="row">
              ...
              <a class="btn btn-primary" href="{{ route('home') }}">Return to home</a>
            </div>
          </div>
        </div>
      </div>
