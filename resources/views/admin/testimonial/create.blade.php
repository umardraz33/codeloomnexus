        ...
        <div class="col-md-8">
          <div class="grid simple form-grid">
            <div class="grid-title">
                <h4>Add <span class="semi-bold"> new testimonial</span></h4>

            </div>
            <div class="grid-body no-border">
              <form action="{{ route('testimonial.store') }}" method="POST" enctype="multipart/form-data"  autocomplete="off">
                @csrf
                <div class="form-group">
                    <label class="form-label">Name</label>
                    <input class="form-control" id="form1Amount" name="name" type="text" placeholder="Please enter the Client's name" required>
                  </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="comment" id="comment" cols="30" rows="4" placeholder="Please enter the comment"></textarea>
                </div>
                <div class="form-group">
