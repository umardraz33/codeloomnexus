        ...
        <div class="col-md-8">
          <div class="grid simple form-grid">
            <div class="grid-title">
                <h4>Edit <span class="semi-bold">team member</span></h4>

            </div>
            <div class="grid-body no-border">
              <form action="{{ route('team.update' , $team->id) }}" method="POST" enctype="multipart/form-data"  autocomplete="off">
                @csrf
                @method('PUT')
                <div class="form-group">
                  <label class="form-label">Name</label>
                  <input class="form-control" id="form1Amount" name="name" type="text" value="{{ $team->name }}">
                </div>
                <div class="form-group">
                    <label class="form-label">Image</label>
                    <input class="form-control" id="form1Amount" name="image" type="file"><span>{{ $team->image }}</span>
                </div>
                <div class="form-group">
                  ...
                  <div class="input-with-icon right">
                    ...
                    <select class="form-control" name="designation">
                        ...
                        <option value="{{ $designation }}" {{ $team->designation == $designation ? 'selected' : '' }}>
                            {{ $designation }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    <div class="checkbox checkbox check-success ">
                        <input type="checkbox" name="is_active" value="1" {{ $team->is_active == 1 ? 'checked' : '' }} id="chkTerms">
