<div class="header navbar navbar-inverse ">
    ...
    <div class="navbar-inner">
      <div class="header-seperation">
        ...
        <!-- BEGIN LOGO -->
        <a href="index.html">
          <h2 class="text-white" style="font-weight: 500 !important; font-size: 24px;
    text-align: center;">CodeLoom Nexus</h2>
          <!-- <img src="assets/img/logo.png" class="logo" alt="" data-src="{{ asset('admin/assets/img/logo.png')}}" data-src-retina="assets/img/logo2x.png" width="106" height="21" /> -->
        </a>
        <!-- END LOGO -->
          ...
          <div style="width:300px">
            <div class="notification-messages info">
              <div class="user-profile">
                <img src="assets/img/profiles/d.jpg" alt="" data-src="{{ asset('admin/assets/img/profiles/d.jpg')}}" data-src-retina="assets/img/profiles/d2x.jpg" width="35" height="35">
              </div>
            ...
            <div class="notification-messages success">
              <div class="user-profile">
                <img src="assets/img/profiles/h.jpg" alt="" data-src="{{ asset('admin/assets/img/profiles/h.jpg')}}" data-src-retina="assets/img/profiles/h2x.jpg" width="35" height="35">
              </div>
              <div class="message-wrapper">
                <div class="heading">
