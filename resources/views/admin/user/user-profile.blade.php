...
<!-- Mirrored from webarch.revox.io/3.0/user-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Dec 2023 19:18:26 GMT -->
    ...
    <div class="header navbar navbar-inverse ">
      ...
      <div class="navbar-inner">
        <div class="header-seperation">
          ...
          <!-- BEGIN LOGO -->
          <a href="index.html">
            <img src="{{ asset('admin/assets/img/logo.png')}}" class="logo" alt="" data-src="{{ asset('admin/assets/img/logo.png')}}" data-src-retina="assets/img/logo2x.png" width="106" height="21" />
          </a>
          <!-- END LOGO -->
            ...
            <div style="width:300px">
              <div class="notification-messages info">
                <div class="user-profile">
                  <img src="{{ asset('admin/assets/img/profiles/d.jpg')}}" alt="" data-src="{{ asset('admin/assets/img/profiles/d.jpg')}}" data-src-retina="assets/img/profiles/d2x.jpg" width="35" height="35">
                </div>
          ...
          <div class="pull-right">
            <div class="chat-toggler sm">
              <div class="profile-pic">
                <img src="assets/img/profiles/avatar_small.jpg" alt="" data-src="{{ asset('admin/assets/img/profiles/avatar_small.jpg')}}" data-src-retina="assets/img/profiles/avatar_small2x.jpg" width="35" height="35" />
        ...
        <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
          <div class="user-info-wrapper sm">
            <div class="profile-wrapper sm">
              <img src="assets/img/profiles/avatar.jpg" alt="" data-src="{{ asset('admin/assets/img/profiles/avatar.jpg')}}" data-src-retina="assets/img/profiles/avatar2x.jpg" width="69" height="69" />
              <div class="availability-bubble online"></div>
            </div>
            ...
            <div class="col-md-9">
              <div class=" tiles white col-md-12 no-padding">
                <div class="tiles green cover-pic-wrapper">
                  ...
                  <img src="{{ asset('admin/assets/img/profiles/' . $user->cover_picture)}}" alt="" style="    width: 50%;
                  display: block;
                  margin: auto;">
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-3 col-sm-3">
                        ...
                        <div class="user-profile-pic">
                          <img width="69" height="69" data-src-retina="{{ asset('admin/assets/img/profiles/' . $user->profile_image)}}" data-src="{{ asset('admin/assets/img/profiles/' . $user->profile_image)}}" src="{{ asset('admin/assets/img/profiles/' . $user->profile_image)}}" alt="">
                        </div>
                    ...
                    <div class="col-md-5 user-description-box  col-sm-5">
                        <div class="edit-icon-container" onclick="openEditModal()">
                            <i class="fa fa-pencil" style="float: right"></i>
                        </div>
                      <h4 class="semi-bold no-margin">{{ $user->name }}</h4>
                      <h6 class="no-margin">{{ $user->email }}</h6>
                      <br>
                      <p><i class="fa fa-briefcase"></i>CEO</p>
                      <p><i class="fa fa-globe"></i>{{ $user->address }}</p>
                      <p><i class="fa fa-file-o"></i>{{ $user->phone }}</p>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('profile.update')}}" method="Post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            <label for="cover_picture" class="col-form-label">Cover Picture:</label>
            <input type="file" class="form-control" id="cover_picture" name="cover_picture">
            <span>{{ $user->cover_picture }}</span>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="phone_number" name="phone_number" value="{{ $user->phone }}">
          </div>
...
<!-- Mirrored from webarch.revox.io/3.0/user-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Dec 2023 19:18:28 GMT -->
</html>
