        ...
        <div class="col-md-8">
          <div class="grid simple form-grid">
            <div class="grid-title">
                <h4>Add <span class="semi-bold"> new blog</span></h4>
            ...
            <div class="grid-body no-border">
              <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data"  autocomplete="off">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="description" id="description" cols="30" rows="6" placeholder="Please enter the description"></textarea>
                </div>
                <div class="form-group">
                    <label class="form-label">Description</label>
                    <textarea class="form-control" name="detail_description" id="description" cols="30" rows="6" placeholder="Please enter the description"></textarea>
                  </div>
                <div class="form-group">
