        ...
        <div class="col-md-8">
          <div class="grid simple form-grid">
            <div class="grid-title">
                <h4>Add <span class="semi-bold"> new service detail</span></h4>

            </div>
            <div class="grid-body no-border">
              <form action="{{ route('servicedetail.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                @csrf
                <div class="form-group">
                    <label class="form-label">Svg</label>
                    <input class="form-control" id="form1Amount" name="svg" type="file">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="description" id="description" cols="30" rows="4" placeholder="Please enter the description"></textarea>
                </div>
                ...
                {{-- <div class="form-group">
                    ...
                    <input class="form-control" id="form1Amount" name="project_overview_image" type="file">
                </div>

                <div class="form-group">
                    <label class="form-label">Project Title</label>
                    <input class="form-control" id="form1Amount" name="project_title" type="text" placeholder="Please enter the title" required>
                </div>

                <div class="form-group">
                    <label class="form-label">Project Description</label>
                    <textarea class="form-control" name="project_description" id="project_description" cols="30" rows="4" placeholder="Please enter the project description"></textarea>
                </div> --}}
