        ...
        <div class="col-md-8">
          <div class="grid simple form-grid">
            <div class="grid-title">
                <h4>Edit <span class="semi-bold"> project</span></h4>
            ...
            <div class="grid-body no-border">
              <form action="{{ route('project.update' , $project->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="form1Amount" name="project_svg" type="file"><span>{{ $project->project_logo }}</span>
                </div>
                <div class="form-group">
                  <label class="form-label">Project Title</label>
                  <input class="form-control" id="form1Amount" name="title" type="text" value="{{ $project->title }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="form1Amount" name="image" type="file"><span>{{ $project->image }}</span>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="servicedetail_id" id="">
                        ...
                        <option value="{{ $servicedetail->id }}" {{ $project->servicedetail_id == $servicedetail->id ? 'selected' : '' }}>{{ $servicedetail->title }}</option>
