    ...
    <div class="content sm-gutter">
      ...
      <div class="page-title">
        ...
        <div class="pull-right">
          <a href="{{ route('service.index') }}" class="btn btn-success" type="submit">Back</a>
        </div>
      </div>
        ...
        <div class="col-md-8">
          <div class="grid simple form-grid">
            <div class="grid-title">
                <h4>Edit <span class="semi-bold"> Service</span></h4>
            ...
            <div class="grid-body no-border">
              <form action="{{ route('service.update' , $service->id) }}" method="POST" autocomplete="off">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="form1Amount" name="title" type="text" value="{{ $service->title }}">
                </div>
